...
class _ProductService implements ProductService {
  ...
  @override
  Future<ListProduct> getPosts() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ListProduct>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ListProduct.fromJson(_result.data!);
    return value;
  }

  @override
  Future<Product> getProductById(int prodcutId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
...
String _$productServiceHash() => r'fb6f9a27f0d3da6d1d8fd1d53cf35a6bd7cd3ef4';
